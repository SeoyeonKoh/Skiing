...
def history_to_video(history_path, output_video_path, fps=30):
    ...
    # OCAtari 환경 초기화
    env = OCAtari(env_name="Asteroids-ramNoFrameskip-v4", mode="vision", obs_mode="ori", render_mode="rgb_array", buffer_window_size=1)
    env.reset()
...
pkl_path = "Replay_object_xywh/ep1_score1030.0.pkl"
